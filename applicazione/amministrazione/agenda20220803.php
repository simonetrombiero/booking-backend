                    ...
                    <form id="formNewEvent" class="addEvent" role="form">
                        ...
                        <div class="form-row">
                         ...
                         <div class="form-group">
                                ...
                                <div class="col-11-12">
                                     <select name="trattamentiAppuntamento" id="trattamentiAppuntamento" style="width: 100%">
...
<!--                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-link" id="addEvent">Salva Appuntamento</button>
    ...
    <div class="modal fade" id="addNew-paziente" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="padding: 30px 10px;">
                    <h4 class="modal-title" style="width: 85%; float: left; padding: 0px 10px;">Nuovo Paziente</h4> <div style="float: right;  padding: 0px 10px; "><button type="button" class="btn btn-link" data-dismiss="modal"><img src="applicazione/img/icone/delete.png" style="width: 15px;"></button></div>
                </div>
                <div class="modal-body">
...
<!--
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-link" id="addPaziente">Salva Paziente</button>
                    <button type="button" class="btn btn-link" data-dismiss="modal">Chiudi</button>
                </div>
            </div>
        </div>
