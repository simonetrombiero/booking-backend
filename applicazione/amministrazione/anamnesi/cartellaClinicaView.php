...
<table style="width: 100%;">
    <tr><td colspan="2" style="font-weight: bold;">Stato iniziale della Bocca: </td></tr>
    ...
    <tr><td style="width: 50%">
            <svg id="Livello_1" data-name="Livello 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 600">
                <script>
                    ...
                    /*
                     //INIZIZZAZIONE MAPPA DENTI
                     function setDentiera(idRiga) {
                     for (var i = 0; i < arrayDenti.length; i++) {
                     
                     //console.log(arrayDenti[i]);
                     if (document.getElementById(arrayDenti[i]).classList.contains("cls-2-sel")) {
                     //document.getElementById("b1").className = "input-error"; 
                     //alert(arrayDenti[i]);
                     document.getElementById(arrayDenti[i]).classList.replace("cls-2-sel", "cls-2");
                     
                     }
                     //$("#"+arrayDenti[i]).attr("class", "cls-2"); se voglio cambiare la proprietà con jquery
                     }
                     
                     dentiSelezionatiTMP = [];
                     //console.log(dentiSelezionatiTMP);
                     var rigaDenti = $("#dentiSelezionati" + idRiga).val();
                     var notePopup = $("#noteDentiSelezionati" + idRiga).val();
                     if (notePopup != '') {
                     $('#noteRigaPopup').val(notePopup);
                     } else {
                     $('#noteRigaPopup').val('');
                     }
                     if (rigaDenti != '') {
                     ...
                     // alert("set" + rigaDenti);
                     // console.log(rigaDenti);
                     dentiSelezionatiTMP = rigaDenti.split(",")
                     // console.log(dentiSelezionatiTMP);
                     }
                     
                     
                     for (var i = 0; i < dentiSelezionatiTMP.length; i++) {
                     
                     
                     if (document.getElementById(dentiSelezionatiTMP[i]).classList.contains("cls-2")) {
                     //document.getElementById("b1").className = "input-error"; 
                     //alert(arrayDenti[i]);
                     document.getElementById(dentiSelezionatiTMP[i]).classList.replace("cls-2", "cls-2-sel");
...
//                            el.classList.replace("cls-2", "cls-2-orange");
//                            dentiSelezionatiTMP.push(el.id);
//                        } else {
//                            el.classList.replace("cls-2-orange", "cls-2");
//                            var index = dentiSelezionatiTMP.indexOf(el.id);
//                            
//                            if (index > -1) {
//                                dentiSelezionatiTMP.splice(index, 1);
//                            }
//                            
//     
//                                           }
...
alert(voti);
                        // alert(el.id);
                        //console.log(dentiSelezionatiTMP); //  ['eat', 'sleep', 'exercise']
                        //$('#test').val(dailyActivities);
                        $("#dentiSelezionati").val(voti);
                        $("#paperino").val(arrayAssociativo);
//                        $("#dentiSelezionati").val(arrayDenti);
                    }
                    /*
                     function Focus_Out() {
                     idRiga = $("#rigaEdit").val();
                     var noteTMP = $("#noteRigaPopup").val();
                     // alert(noteTMP);
                     $("#noteDentiSelezionati" + idRiga).val(noteTMP);
                     //alert("wwwwwwwwwwww");  
                     }
                     */
                </script>
