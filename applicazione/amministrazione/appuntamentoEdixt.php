                                        ...
                                        <td style="border-bottom: 1px dotted #057fd0;">
                                            <select name="postazione<?php echo $i; ?>">
                                                ...
                                                for ($j = 0; $j < count($postazioni); $j++) {
                                                    ...
                                                    ?>
                                                <option value="<?php echo $postazione->id ?>" <?php if ($postazione->id == $trattamento->idPostazione) {
                                                        echo 'selected=""';
                                            ...
                                            <td style="border-bottom: 1px dotted #057fd0;">
                                                <select name="operatore<?php echo $i; ?>">
                                                    ...
                                                    for ($k = 0; $k < count($operatori); $k++) {
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $operatore->id ?>" <?php if ($operatore->id == $trattamento->idOperatore) {
                                                            echo 'selected=""';
