...
<!--<span class="titleTasti">Cerca Cliente:</span>&nbsp;<input type="text" style="width:80%; height:30px; border:1px solid #CCC; border-radius: 5px; padding-left:5px; padding-right:5px;">&nbsp;<input type="image" src="img/icone/view.png" width="30">-->
                    ...
                    <div style="width: 100%; border: 1px solid #CCC; border-radius: 10px; padding: 10px;">
                        ...
                        <span style="font-weight: bolder;">Stato Appuntamento</span> <br>
...
<!--                        <input type="text" name="dataAppuntamento" id="dataAppuntamento" value="<?php echo $data; //if(isset($appuntamento->data)){ echo dateFromDb($appuntamento->dataNascita); }    ?>" style="width: 45%; padding: 5px; border-radius: 5px; border: solid 1px rgb(204, 204, 204);" placeholder="Data Appuntamento" required="" />-->
                        <div style="clear:left;">&nbsp;</div>
                        <span style="font-weight: bolder;">Data Appuntamento, Ora Inizio e Fine </span> <br>

                        <input type="text" name="dataAppuntamento" id="dataAppuntamento" value="<?php echo $data; //if(isset($appuntamento->data)){ echo dateFromDb($appuntamento->dataNascita); }    ?>" style="width: 30%; padding: 5px; border-radius: 5px; border: solid 1px rgb(204, 204, 204);" placeholder="Data Appuntamento" required="" />&nbsp;<input type="text" name="OraInizioAppuntamento" id="OraInizioAppuntamento" value="<?php echo $ore; //if(isset($appuntamento)){ echo $appuntamento->inizio; }    ?>" style="width: 30%; padding: 5px; border-radius: 5px; border: solid 1px rgb(204, 204, 204);" class="timepicker" required="" placeholder="Ora Inizio">
                        <input type="text" name="OraFineAppuntamento" id="OraFineAppuntamento"  value="<?php //if(isset($appuntamento)){ echo $appuntamento->fine; }    ?>" class="timepicker" style="width: 30%; padding: 5px; border-radius: 5px; border: solid 1px rgb(204, 204, 204);" placeholder="Ore Fine">&nbsp;&nbsp;<a href="javascript: verificaDisponibilita();"><img src="img/icone/view.png" width="30"></a>
                        <div id="verificaApp">&nbsp;</div>
                    </div>
