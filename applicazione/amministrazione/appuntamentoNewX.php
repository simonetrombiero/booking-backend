                    ...
                    <div>
                        ...
                        $operatori = DAOFactory::getDipendenteDAO()->queryAll();
                                ...
                                <tr <?php echo $backgroundTR; ?>>
                                    ...
                                    <td style="border-bottom: 1px dotted #057fd0;"><input type="hidden" name="idTrattamento" id="idTrattamento<?php echo $i; ?>" value="<?php echo $trattamento->id; ?>">
                                        ...
                                        <td style="border-bottom: 1px dotted #057fd0;">
                                            <input type="text" name="dataAppuntamento" id="dataAppuntamento<?php echo $i; ?>" value="<?php echo $data; //if(isset($appuntamento->data)){ echo dateFromDb($appuntamento->dataNascita); }    ?>" style="width: 90%; padding: 5px; border-radius: 5px; border: solid 1px rgb(204, 204, 204); min-width: 60px;" placeholder="Data Appuntamento" required="" />&nbsp;<input type="text" name="OraInizioAppuntamento" id="OraInizioAppuntamento<?php echo $i; ?>" value="<?php echo $ore; //if(isset($appuntamento)){ echo $appuntamento->inizio; }    ?>" style="width: 90%; padding: 5px; border-radius: 5px; border: solid 1px rgb(204, 204, 204);" class="timepicker" required="" placeholder="Ora Inizio"></td>
                                        <td style="border-bottom: 1px dotted #057fd0;">
...
//VERIFICA PRESENZA APPUNTAMENTO
        ...
        function prenotazioneAggiungiTrattamento(id, riga) {
           ...
           // var dati3 = $('#dataAppuntamento').val();
            ...
            var data_send = "dato1=" + seduteN + "&dato2=" + dati2 + "&dato3=" + dati3;
