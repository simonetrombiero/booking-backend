                        ...
                        <tr><td colspan="3"><hr></td></tr>
                         <tr>
                            ...
                            <td style="font-weight: bold;">
                                ...
                                $statotmp = DAOFactory::getPianoTrattamentoStatusDAO()->load($appuntamento->status);
...
<!--              <tr>
  ...
  <td><input type="submit" class="btn btn-green" value="Salva"></td>
                        ...
                        <tr>
                            <td colspan="3" style="height: 35px; width: 100%; background-color: #366c88; color: #FFF; border-bottom: 1px dotted #CCC; font-weight: bold;">&nbsp;PIANO TRATTAMENTO DEL <?php echo dateFromDb($pianoTrattamento->data); ?>LISTA SEDUTE ASSOCIATE AL PIANO</td>
                        </tr>
                        <?php
                        ...
                        for ($i = 0; $i < count($trattamenti); $i++) {
                            ...
                            <tr>
                                <td colspan="3" style="height: 30px; border-bottom: 1px dotted #CCC;">
                                    <div style="width: 90%; height: 30px; line-height: 30px; float: left; <?php if($trattamento->id==$appuntamento->id){echo "background: #B2B2B2;";} ?>">&bull;&nbsp;<?php echo dateFromDb($trattamento->data). "&nbsp;&nbsp;ore ".substr($trattamento->oraInizio, 0,5)."&nbsp;&nbsp;&nbsp;&nbsp;". $trattamentotmp."&nbsp;&nbsp;&nbsp;&nbsp;".$trattamentoBox->postazione."&nbsp;&nbsp;&nbsp;&nbsp;".$trattamentoOperatore->nome." ".$trattamentoOperatore->cognome; 
