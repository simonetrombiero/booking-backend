        ...
        <div>
            <div style="width: 100%; height: 60px; background-color: #f6f6f6;">
                                            ...
                                            <div style=" text-align: right; padding: 10px 15px;">
                                                <a href="index.php?action=nuovoCalendario" class="btn btn-green" >Nuovo Calendario</a>
                                            </div>
                                        </div></div>
    <!--</div>-->
<!--</div>-->
    ...
    <!--<div class="col-1-1">-->
        <div style="padding: 10px;">
                                            ...
                                            <table style="width: 100%" id="datatable">
                                                ...
                                                <tbody>
                                                    <?php
                                                    for ($i = 0; $i < count($listaCalendari); $i++) {
                                                        $calendario = $listaCalendari[$i];
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td style="border-bottom: 1px dotted #057fd0;">
                                                             <?php
                                                                if(!isBlankOrNull($calendario->idPostazione)){
                                                                    $postazione = DAOFactory::getPostazioniDAO()->load($calendario->idPostazione);
...
<!--                                                                <a href="#" onclick="document.getElementById('gestioneCalendario').id.value='<?php // echo $calendario->id; ?>'; document.getElementById('gestioneCalendario').action.value='visualizzaCalendario'; document.getElementById('gestioneCalendario').submit();">
                                                                    <img src="img/icone/view.png" alt="Verifica Annuncio" title="Verifica Annuncio" style="width: 25px; padding: 2px"/></a>-->
                                                                <a href="#" onclick="document.getElementById('gestioneCalendario').id.value='<?php echo $calendario->id; ?>'; document.getElementById('gestioneCalendario').action.value='modificaCalendario'; document.getElementById('gestioneCalendario').submit();">
                                                                    <img src="applicazione/img/icone/edit.png" alt="Modifica" title="Modifica" style="width: 25px; padding: 2px"/></a>
                                                                
                                                                <a href="index.php?action=eliminaCalendario&amp;id=<?php echo $calendario->idclienti; ?>">
