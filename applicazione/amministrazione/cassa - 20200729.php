                           ...
                           ?> 
                            ...
                            <td style="width: 300px;">
                                    <div class="simpleCart_shelfItem">
                                        <h5 class="item_name"><?php echo $trattamento->trattamento; ?></h5>
                                        
                                        <span class="item_price"><strong>€&nbsp;<?php echo $trattamento->costo; ?></strong></span>
                                        <br>
                                        <noscript><a href="no_javascript.html" class="item_add">Aggiungi</a></noscript>
                                        <script>document.write('<a href="#" class="item_add btn btn-green">Aggiungi</a>');</script>
                            ...
                            <div style="background: #ddd; width: 100%; border: 1px solid #CCC; border-radius: 10px; padding: 10px;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        ...
                                        <td style="width: 50%; text-align: right; vertical-align: central;"><strong>TOTALE&nbsp;</strong></td>
                                        <td rowspan="2" style="width: 50%; text-align: right; vertical-align: central;"><div id="cartTotal"><strong><span class="simpleCart_total"></span></strong></div></td>
                                    </tr>
<!--                                    <tr>
                                        <td style="width: 35%; text-align: left;">Rivendita</td><td style="width: 15%; text-align: right">0,00</td></tr>
                                    <tr>
                                        <td style="width: 35%; text-align: left;">Tessera</td>
                                        <td style="width: 15%; text-align: right">0,00</td>
                                        <td style="width: 35%; text-align: right;">Totale Complessivo</td>
                                        <td style="width: 15%; text-align: right">0,00</td></tr>
                                    <tr>
                            ...
                            <div>Modalità di Pagamento 
                                <select>
                                    <option>Contanti</option>
                                     <option>Bancomat/Carta di credito</option>
                                     <option>Assegno</option>
                                         
                                </select></div>
                            <div>Sconto
                            <input type="text"></div>
                            <div>Sospesi / Pagamenti Registra Pagamento</div>
