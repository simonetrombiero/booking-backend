...
<!--                        <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td><a href="#" onclick="document.getElementById('gestioneCliente').submit();" class="btn btn-green" >(+) Appuntamento</a></td>
                            <td>&nbsp;</td>
        ...
        <div class="col-1-2">
            <div class="content">
                <fieldset class="border">
                    <legend>Piano Terapeutico: </legend> 
                    ...
                    <div style="float: left; width: 50%; padding: 10px 15px;">
                        <a href="#" onclick="document.getElementById('pianoTerapeutico').submit();" class="btn btn-green">Piano di Cura</a>
                   ...
                   <fieldset class="border">
                    ...
                    <div style="float: left; width: 50%; padding: 10px 15px;">
                         <a href="#" onclick="document.getElementById('schedaMorfologica').submit();" class="btn btn-green" >Documenti</a>
                    </div>
...
<!--                </fieldset>
                ...
                <fieldset class="border">-->
                    ...
                    <div style="clear:left;">&nbsp;</div>
                     <div style="float: left; width: 50%; padding: 10px 15px;">
                         <a href="#" onclick="document.getElementById('schedaMorfologica').submit();" class="btn btn-green" >Consensi</a>
                    </div>
                    <div style="float: left; width: 50%; padding: 10px 15px;">
                         <a href="#" onclick="document.getElementById('schedaMorfologica').submit();" class="btn btn-green" >Anamnesi</a>
                    </div>
...
?>
                    ...
                    <form action="index.php" id="gestioneRichiami" name="gestioneRichiami" method="post">
                        <input type="hidden" id="action" name="action" value="listaRichiami">
                        <input type="hidden" id="idCliente" name="idCliente" value="<?php echo $cliente->id; ?>">
                    </form>
