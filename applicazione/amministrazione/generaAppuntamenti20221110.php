...
//            $pianoTrattamento->id;
                ...
                <div class="form-group col-6-12">
                    ...
                    <input type="text" class="form-control timepicker" name="oraAppuntamento" id="oraAppuntamento" placeholder="hh:mm">
                </div>
                <div class="form-group col-6-12">
                    <label for="dataAppuntamento">Numero Sedute</label>
                    <?php echo $pianoTrattamento->seduteNumero; ?>
                </div>
                <div class="form-group col-6-12">
    ...
    <?php echo $trattamentoItem->trattamento; ?>
                            ...
                            <td>
                                <select name="operatoreAppuntamento<?php echo $i; ?>" id="operatoreAppuntamento">
    ...
    for ($kk = 0; $kk < count($operatoriAll); $kk++) {
        ...
        ?>
                            ...
                            <td>
                                <select name="postazioneAppuntamento<?php echo $i; ?>" id="postazioneAppuntamento">
                                    <option>-- Seleziona --</option>
    <?php
