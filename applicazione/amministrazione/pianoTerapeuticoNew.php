...
<?php include 'applicazione/amministrazione/morfologica/schedaNew.php'; ?>
                        <div style="margin-top: 20px;">
                            <textarea name="notePiano" id="notePiano" placeholder="Note" style="width: 450px; height: 130px;"></textarea> 
...
?>"></td>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td>
                                        <select name="statoPiano" required="">
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><input type="date" name="dataCreazione" id="dataCreazione" value="<?php
                                        if (isset($incarico)) {
                                            echo $incarico->nome;
                                        }
                                        ?>"></td>
                                ...
                                <tr>
                                    <td>Data Inizio </td>
                                    <td>&nbsp;</td>
                                    <td><input type="date" name="dataInizio" id="dataInizio" value="<?php
                                        if (isset($incarico)) {
                                            echo $incarico->nome;
                                        }
                                        ?>"></td>
...
//alert (tot);
                ...
                $itemlist.append(
                        '<tr>\
                    <td><input type="hidden" name="trattamenti[]" value="' + idTratt + '"><input class="form-control input-sm text-right" data-cell="A' + i + '" data-format="0" value="' + qta + '" name="quantita[]"></td>\
