                     ...
                     <div style="padding: 10px;">
                        ...
                        <table>
                            <tr>
                                <td>Titolo </td>
                                <td>&nbsp;</td>
                                <td><input type="text" name="nomeIncarico" id="nomeIncarico" value="<?php if (isset($incarico)) {
    echo $incarico->nome;
} ?>"></td>
                            </tr>
                              <tr>
                            ...
                            <tbody>
                                ...
                                <tr <?php echo $backgroundTR; ?>>
                                        <td style="border-bottom: 1px dotted #057fd0;">
                                            <input name="nSedute" id="nSedute<?php echo $i; ?>" style="min-width:30px; width: 30px;">
