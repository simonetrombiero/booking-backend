            ...
            <div>
                <div style="width: 100%; height: 60px; background-color: #f6f6f6;">
                    <h2 style="float: left; padding: 0px 15px; color: #366c88;">
                        MODIFICA PIANO TRATTAMENTO CLIENTE: <?php echo $cliente->nome . " " . $cliente->cognome; ?>
...
<?php include 'applicazione/amministrazione/morfologica/schedaNew.php'; ?>
    ...
    <!--                    <p style="color: black; font-size: 1.2em; font-weight: bold;">PIANO DI CURA</p>-->
                        <table>
                            ...
                            <tr><td>Numero Sedute</td><td><input type="text"  name="numeroSedute" id="numeroSedute" value="<?php echo $pianoTrattamento->seduteNumero; ?>"></td></tr>
                        ...
                        <div style="background: #ddd; width: 100%; border: 1px solid #CCC; border-radius: 10px; padding: 10px;">
                            ...
                            <table style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    ...
                                    <td style="width: 60%; text-align: right; vertical-align: central; font-size: 1.2em"><strong>TOTALE PIANO TRATTAMENTO&nbsp;</strong></td>
