        ...
        <div>
            <div style="width: 100%; height: 60px; background-color: #f6f6f6;">
                                            <h2 style="float: left; padding: 0px 15px; color: #366c88;">
                                                LISTA RICHIAMI PAZIENTE: <?php echo $cliente->nome. " ".$cliente->cognome;  ?>
                                                ...
                                                <thead>
                                                    <tr>
                                                      ...
                                                      <th align="left">Data </th>
                                                        ...
                                                        <th align="left" style="width: 15%;">Stato</th>
                                                        <th align="left" style="width: 15%;">Note</th>
                                                        <th>
                                                            Azioni
                                                        </th>
                                                    </tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td style="border-bottom: 1px dotted #057fd0;">
                                                            ...
                                                            <td style="vertical-align: middle; text-align: center; border-bottom: 1px dotted #057fd0;">
                                                                ...
                                                                <a href="#" onclick="document.getElementById('gestioneRichiami').id.value='<?php echo $richiamo->id; ?>'; document.getElementById('gestioneRichiami').action.value='visualizzaCliente'; document.getElementById('gestioneRichiami').submit();">
                                                                    <img src="img/icone/view.png" alt="Verifica Annuncio" title="Verifica Annuncio" style="width: 25px; padding: 2px"/></a>
                                                                <a href="#" onclick="document.getElementById('gestioneRichiami').id.value='<?php echo $richiamo->id; ?>'; document.getElementById('gestioneRichiami').action.value='modificaCliente'; document.getElementById('gestioneRichiami').submit();">
