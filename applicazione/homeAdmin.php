...
<form action="index.php" id="gestionePianoCura" name="gestionePianoCura" method="post">
                    <input type="hidden" id="action" name="action">
        ...
        <div class="grid grid-pad">
            ...
            <a href="index.php?action=prestazioniPazienti">
               ...
               <div class="box textCenter">
                    ...
                    <span class="titleTasti">PRESTAZIONI CLIENTE (Presenze)</span>
                </div>
                </a>
            </div>
            <div class="col-1-3">
               ...
               <a href="index.php?action=listaRichiami">
                <div class="box textCenter">
                    <p><img src="img/richiami.png"></p>
                    <span class="titleTasti">RICHIAMI CLIENTI</span>
                </div>
                </a>
        <?php //}  ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-bottom: 1px dotted #057fd0;">
                                                                ...
                                                                if(!isBlankOrNull($prenotazione->idCliente)){
                                                                    ?>
                                                                <a href="#" onclick="document.getElementById('gestioneCliente').idCliente.value='<?php echo $prenotazione->idCliente; ?>'; document.getElementById('gestioneCliente').action.value='visualizzaCliente'; document.getElementById('gestioneCliente').submit();">
                                                                <?php
                                                            ...
                                                            <td style="border-bottom: 1px dotted #057fd0;">
                                                                <?php 
                                                                if(!isBlankOrNull($prenotazione->idPiano)){ ?>
                                                                <a href="#" onclick="document.getElementById('gestionePianoCura').idPiano.value='<?php echo $prenotazione->idPiano; ?>'; document.getElementById('gestionePianoCura').action.value='visualizzaPiano'; document.getElementById('gestionePianoCura').submit();">
                                                                <?php
                                                                
                                                                    $piano = DAOFactory::getPianoTrattamentoDAO()->load($prenotazione->idPiano);
                                                                    echo $piano->titolo;
                                                            ...
                                                            <td style="vertical-align: middle; text-align: center; border-bottom: 1px dotted #057fd0;">
                                                                ...
                                                                <a href="#" onclick="document.getElementById('gestionePrenotazione').id.value='<?php echo $prenotazione->id; ?>'; document.getElementById('gestionePrenotazione').action.value='visualizzaAppuntamento'; document.getElementById('gestionePrenotazione').submit();">
